...
<body>
  <header>
    <img src="../../../assets/images/LogoEscolaSemFundo.png" alt="Logo da Clinica" class="LogoClinica">Meu Per
    <div class="areauser">
  ...
  <div class="container">
    <form class="form-cad" id="form-cad" action="../backend/editar-email.php" method="POST">
      <div class="coluna">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="email-pessoal" id="email-pessoal" placeholder="Insira seu e-mail" value="ALTERAR PARA OQ VEM DO BANCO">
        </div>
        <div class="form-group">
    ...
    <button type="submit" class="btnExcluir">Confirmar alteração de e-mail</button>
